...
alias not="cd ~/Documents/50-notes/"
alias jrn="cd ~/Documents/50-notes/60-journal/"
alias cdn="cd ~/Documents/50-notes/61-coding/"
alias lnx="cd ~/Documents/50-notes/62-linux/"
