...
groups.append(ScratchPad("0", [
    ...
    DropDown("tasklist", "alacritty '-e' '/home/abrar/.config/scripts/tasklist.sh'", width=0.6, height=0.7, x=0.2, y=0.1, opacity=1, on_focus_lost_hide=False),
    DropDown("lf", "alacritty '-e' 'lf'", width=0.6, height=0.7, x=0.2, y=0.1, opacity=1, on_focus_lost_hide=False),
