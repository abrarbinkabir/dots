...
function fd {
    base="$(find ~/Documents/ ~/Downloads/ ~/Pictures/ ~/dots/ ! -path '*/.*' ! -path '/home/abrar/Documents/archives*' | sort | cut -d '/' -f4- |fzf -e -i --reverse --header='Search files and folders')"
    file="/home/abrar/$base"
...
export PATH=/home/abrar/dots/scripts:$PATH
